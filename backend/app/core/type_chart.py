"""
TABELA DE EFETIVIDADE DE TIPOS — port 1:1 de src/data/typeChart.ts.

Multiplicadores: 2 = super efetivo, 1 = normal, 0.5 = pouco efetivo,
0 = imune. Formato: TYPE_CHART[tipo_ataque][tipo_defesa] = multiplicador.
Matriz explícita (18×18 preenchidas), sem valor-padrão implícito — mesma
justificativa do TS: acesso sempre data-driven, nenhuma regra de tipo
escrita dentro do motor (ver type_calculator.py).
"""
